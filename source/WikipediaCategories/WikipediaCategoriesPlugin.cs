...
public class WikipediaCategoriesPlugin : MetadataPlugin
{
    ...
    public override OnDemandMetadataProvider GetMetadataProvider(MetadataRequestOptions options)
        => new WikipediaCategoryMetadataProvider(new WikipediaGameSearchProvider(new(new WebDownloader(), PlayniteApi.ApplicationInfo.ApplicationVersion)), options, PlayniteApi, new PlatformUtility());
    ...
    private void ImportGameProperty()
    {
        ...
        var bulk = new WikipediaCategoryBulkImport(PlayniteApi.Database, new(PlayniteApi), searchProvider, new PlatformUtility(PlayniteApi), _settings.Settings.MaxDegreeOfParallelism);

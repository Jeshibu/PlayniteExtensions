    ...
    public static XboxMetadataSettings GetInitialSettings()
    {
        return new XboxMetadataSettings()
        {
            Cover = new XboxImageSourceSettings
            {
                ...
                Fields = [new CheckboxSetting(ImageSourceField.Poster, true), new CheckboxSetting(ImageSourceField.BoxArt, true), new CheckboxSetting(ImageSourceField.AppStoreProductImage, true), new CheckboxSetting(ImageSourceField.SuperHeroArt, false), new CheckboxSetting(ImageSourceField.Screenshots, false)],
            },
            Background = new XboxImageSourceSettings
            {
                ...
                Fields = [new CheckboxSetting(ImageSourceField.SuperHeroArt, true), new CheckboxSetting(ImageSourceField.Screenshots, true), new CheckboxSetting(ImageSourceField.BoxArt, false), new CheckboxSetting(ImageSourceField.Poster, false), new CheckboxSetting(ImageSourceField.AppStoreProductImage, false)],
            },
        };
    }
}
...
{
    public List<CheckboxSetting> Fields { get; set; } = [];
